...
setup(
  name="newsum",
  version=__version__,
  url="https://github.com/Stephen-Borbi/summinews",
  download_url="https://github.com/Stephen-Borbi/summinews",
  author="Stephen Borbi"
  author_email="stephenborbi@gmail.com",
